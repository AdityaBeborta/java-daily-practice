...
public class Daily_02052025 {
//create an arraylist of Integers and sort it in ascending order as well as in descending order
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(originalList, new MyComparator());
